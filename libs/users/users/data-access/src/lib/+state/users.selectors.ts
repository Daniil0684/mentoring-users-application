...
export const selectTimers = createSelector(selectUsersState,
  (state) => state.timers);

export const selectTimerByUserId = (userId: number) =>
  createSelector(selectTimers, (timers) => timers[userId] || null);

const { selectAll, selectEntities } = usersAdapter.getSelectors();

export const selectUsersStatus = createSelector(selectUsersState,
...
export const selectUsersEntities = createSelector(selectUsersState,
  (state: UsersState) => selectEntities(state));

export const selectSelectedId = createSelector(selectUsersState,
  (state: UsersState) => state.selectedId);

export const selectEntity = createSelector(selectUsersEntities, selectSelectedId,
  (entities, selectedId) =>
